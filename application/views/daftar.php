            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form class="md-float-material form-material" action="<?= base_url()?>daftar/insert" method="post">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <div class="text-center">
                                                ...
                                                <h5 class="mb-3"><strong>Daftar Member</strong><h5>
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" id="nama_member" name="nama_member" class="form-control" required="" placeholder="Nama Lengkap">
                                   ...
                                   <div class="form-group form-primary text-center">
                                        <span> Sudah Punya Akun? </span><a href="<?= base_url() ?>login"> Login </a>
                                        <br>
