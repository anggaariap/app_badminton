        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="<?php echo base_url().'lapangan/update'?>" method="post" enctype="multipart/form-data">
                        
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nama Lapangan</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_lapangan" name="nama_lapangan" required="required" value="<?= $data['nama_lapangan'] ?>">
                                <input type="hidden" id="id_lapangan" name="id_lapangan" required="required" class="form-control " value="<?= $data['id_lapangan'] ?>">
                            </div>
                        </div>
