        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="<?php echo base_url().'jadwal/insert'?>" method="post" enctype="multipart/form-data">

                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Jam</label>
                            <div class="col-sm-8">
                                <input type="time" class="form-control" id="jam" name="jam" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <a href="<?= base_url()?>jadwal" class="btn btn-warning m-b-0">Kembali</a>
