        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="<?php echo base_url().'member/insert'?>" method="post" enctype="multipart/form-data">

                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nama Member</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_member" name="nama_member" required="required">
                            </div>
                        </div>
