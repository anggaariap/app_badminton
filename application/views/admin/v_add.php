                ...
                <div class="card-block">
                    ...
                    <form action="<?php echo base_url().'admin/insert'?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="email_admin" name="email_admin" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="password" class="form-control" id="password_admin" name="password_admin" required="required">
                            </div>
                        </div>
